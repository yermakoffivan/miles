# Vendored verbatim from sgl-project/sglang @ cb05a44f35a7c9e27e46d74112cc841ca674ef43
# (python/sglang/srt/entrypoints/anthropic/protocol.py, Apache-2.0).
# Everything below the marker is byte-identical to the upstream blob; see
# UPSTREAM.md for provenance, checksums, and the adaptation ledger.
# --- BEGIN VERBATIM UPSTREAM SOURCE ---
